...
var challengestatement = getchallenge();
...
$('#save-challenge-btn').on('click', function(e) {
  recognition.stop();

  if(!challengecontent.length) {
    instructions.text('Could not save empty challenge statement. Please add some challenge/question to your test.');
  }
...
function getchallenge() {
  return ${challengetextarea.content};
}
