...
MEDIA_ROOT = os.path.join(PROJECT_PATH, 'userdata')
...
MIDDLEWARE_CLASSES = (
    ...
    'skillstest.tySecurityMiddleware.TestYardSecurityMiddleware',
)
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': '/home/supmit/work/ty_newiface/testyard_info.log',
        },
    },
    'loggers': {
        'django': {
...
SESSION_COOKIE_SECURE = False # TODO: Should be set  to True later to enable HTTPS
