...
urlpatterns += patterns('',
    ...
    url(r'%s$'%mysettings.GOOGLE_INFO_URL, 'skillstest.views.storegoogleuserinfo', name='storegoogleuserinfo'),
    url(r'%s$'%mysettings.GOOGLE_LOGIN_URL, 'skillstest.views.storegoogleuserinfo', name='storegooglelogin'),
