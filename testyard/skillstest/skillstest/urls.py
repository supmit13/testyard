...
urlpatterns += patterns('',
    ...
    url(r'%s$'%mysettings.PLANS_DASHBOARD_URL, 'skillstest.Subscription.views.showsubscriptiondashboard', name='showsubscriptiondashboard'),
    url(r'%s$'%mysettings.CANCEL_SUBSCRIPTION_URL, 'skillstest.Subscription.views.cancelsubscription', name='cancelsubscription'),
    url(r'%s$'%mysettings.BUYPLAN_URL, 'skillstest.views.buyplan', name='buyplan'),
