...
urlpatterns += patterns('',
    ...
    url(r'%s$'%mysettings.SUBSCRIPTION_URL, 'skillstest.Subscription.views.showsubscriptiondashboard', name='showsubscriptiondashboard'),
    ...
    url(r'%s$'%mysettings.DOWNLOAD_MY_DATA_URL,'skillstest.Tests.views.downloadmydata', name='downloadmydata'),
    ...
    url(r'%s$'%mysettings.CANCEL_SUBSCRIPTION_URL, 'skillstest.Subscription.views.cancelsubscription', name='cancelsubscription'),
    url(r'%s$'%mysettings.BUYPLAN_URL, 'skillstest.Subscription.views.buyplan', name='buyplan'),
    ...
    url(r'%s$'%mysettings.CANCEL_INTERVIEW_SCHEDULE_URL, 'skillstest.Tests.views.cancelinterviewschedule', name='cancelinterviewschedule'),
