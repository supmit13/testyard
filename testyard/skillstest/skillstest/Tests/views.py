...
def get_user_tests(request):
    ...
    if test_created_count <= mysettings.NEW_USER_FREE_TESTS_COUNT: # Also add condition to check user's 'plan' (to be done later)
        ...
        interviewlink = "<a href='#/' onClick='javascript:showcreateinterviewform(&quot;%s&quot;);loaddatepicker();'>Video Calls</a>"%(userobj.id)
...
def _challenge_edit_form(request, testobj, lastchallengectr, evendistribution, challengedurationseconds, negativescoring=False, multiprogenv = ""):
    ...
    if testtype == 'COMP':
        ...
        if testtype == 'MULT':
            ...
            edit_challenge_dict['responsekeyscontrolslist'] += "<div class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;text-align:right;display:inline-block;color:#0000AA;'>Option #a: </div> <div class='float-left' style='width:50%;color:#0000AA;'><input type='checkbox' name='responsekey[]' value='' style='display:inline-block;'></div></div><br/><div class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;text-align:right;display:inline-block;color:#0000AA;'>Option #b: </div> <div class='float-left' style='width:50%;color:#0000AA;'><input type='checkbox' name='responsekey[]' value='' style='display:inline-block;'></div></div><br /><div class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;text-align:right;display:inline-block;color:#0000AA;'>Option #c: </div> <div class='float-left' style='width:50%;color:#0000AA;'><input type='checkbox' name='responsekey[]' value='' style='display:inline-block;'></div></div><br /><div class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;text-align:right;display:inline-block;color:#0000AA;'>Option #d: </div> <div class='float-left' style='width:50%;color:#0000AA;'><input type='checkbox' name='responsekey[]' value='' style='display:inline-block;'></div></div><br /><div class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;text-align:right;display:inline-block;color:#0000AA;'>Option #e: </div> <div class='float-left' style='width:50%;color:#0000AA;'><input type='checkbox' name='responsekey[]' value='' style='display:inline-block;'></div></div><br /><div class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;text-align:right;display:inline-block;color:#0000AA;'>Option #f: </div> <div class='float-left' style='width:50%;color:#0000AA;'><input type='checkbox' name='responsekey[]' value='' style='display:inline-block;'></div></div><br /><div class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;text-align:right;display:inline-block;color:#0000AA;'>Option #g: </div> <div class='float-left' style='width:50%;color:#0000AA;'><input type='checkbox' name='responsekey[]' value='' style='display:inline-block;'></div></div><br /><div class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;text-align:right;display:inline-block;color:#0000AA;'>Option #h: </div> <div class='float-left' style='width:50%;color:#0000AA;'><input type='checkbox' name='responsekey[]' value='' style='display:inline-block;'></div></div><br />"
        else:
...
def editchallenge(request):
    ...
    if challengeobj.challengetype == 'MULT':
        ...
        if challenge_dict['oneormore']:
            challenge_dict['answeringoptions'] += "<span class='slide-container row'><div class='slide align-items-start'><font color='#0000AA' style='font-weight:bold;justify:left;padding-left:10px;padding-right:10px;'>Can there be more than one correct option:&nbsp;</font></div><div class='align-items-end' style='width:50%;color:#0000AA;'><label class='radio-inline control-label' style='color:#0000AA;'><input type='radio' name='oneormore' value='yes' checked=true onchange='javascript:displayresponsekeycontrols();' class='form-control' style='height:35px;'>Yes</label>&nbsp;&nbsp;&nbsp;&nbsp;<label class='radio-inline control-label' style='color:#0000AA;'><input type='radio' name='oneormore' value='no' onchange='javascript:displayresponsekeycontrols();' class='form-control' style='height:35px;'>No</label></div></span><br />"
        else:
        ...
        challenge_dict['answeringoptions'] += "<span class='slide-container' style='width:100%;'><div class='slide' style='width:100%;'><font color='#0000AA' style='font-weight:bold;justify:left;padding-left:10px;padding-right:10px;'>Please enter the options you want to be made available for this challenge/question.(max 8 options) </font></div></span><br />"
        #print challenge_dict['options'][4]
        if challenge_dict['options'].__len__() > 0 and challenge_dict['options'][0]:
            challenge_dict['answeringoptions'] += "<span class='slide-container' style='width:100%%;'><div class='slide' style='width:100%%;'><font color='#0000AA' style='font-style:italic;text-align:left;display:inline-block;'>Option #a:&nbsp;<input type='text' name='choice1' value='%s' onblur='javascript:displayresponsekeycontrols();' class='form-control input-ty-tiny' style='display:inline-block;'></font></div></span><br />"%(challenge_dict['options'][0])
        else:
            challenge_dict['answeringoptions'] += "<span class='slide-container' style='width:100%;'><div class='slide' style='width:100%;'><font color='#0000AA' style='font-style:italic;text-align:left;display:inline-block;'>Option #a:<input type='text' name='choice1' value='' onblur='javascript:displayresponsekeycontrols();' class='form-control input-ty-tiny' style='display:inline-block;'></font></div></span><br />"
        if challenge_dict['options'].__len__() > 1 and challenge_dict['options'][1]:
            challenge_dict['answeringoptions'] += "<span class='slide-container' style='width:100%%;'><div class='slide' style='width:100%%;'><font color='#0000AA' style='font-style:italic;text-align:left;display:inline-block;'>Option #b:<input type='text' name='choice2' value='%s' onblur='javascript:displayresponsekeycontrols();' class='form-control input-ty-tiny' style='display:inline-block;'></font></div></span><br />"%(challenge_dict['options'][1])
        else:
            challenge_dict['answeringoptions'] += "<span class='slide-container' style='width:100%;'><div class='slide' style='width:100%;'><font color='#0000AA' style='font-style:italic;text-align:left;display:inline-block;'>Option #b: <input type='text' name='choice2' value='' onblur='javascript:displayresponsekeycontrols();' class='form-control input-ty-tiny' style='display:inline-block;'></font></div></span><br />"
        if challenge_dict['options'].__len__() > 2 and challenge_dict['options'][2]:
            challenge_dict['answeringoptions'] += "<span class='slide-container' style='width:100%%;'><div class='slide' style='width:100%%;'><font color='#0000AA' style='font-style:italic;text-align:left;display:inline-block;'>Option #c:<input type='text' name='choice3' value='%s' onblur='javascript:displayresponsekeycontrols();' class='form-control input-ty-tiny' style='display:inline-block;'></font></div></span><br />"%(challenge_dict['options'][2])
        else:
            challenge_dict['answeringoptions'] += "<span class='slide-container' style='width:100%;'><div class='slide' style='width:100%;'><font color='#0000AA' style='font-style:italic;text-align:left;display:inline-block;'>Option #c: <input type='text' name='choice3' value='' onblur='javascript:displayresponsekeycontrols();' class='form-control input-ty-tiny' style='display:inline-block;'></font></div></span><br />"
        if challenge_dict['options'].__len__() > 3 and challenge_dict['options'][3]:
            challenge_dict['answeringoptions'] += "<span class='slide-container' style='width:100%%;'><div class='slide' style='width:100%%;'><font color='#0000AA' style='font-style:italic;text-align:left;display:inline-block;'>Option #d:<input type='text' name='choice4' value='%s' onblur='javascript:displayresponsekeycontrols();' class='form-control input-ty-tiny' style='display:inline-block;'></font></div></span><br />"%(challenge_dict['options'][3])
        else:
            challenge_dict['answeringoptions'] += "<span class='slide-container' style='width:100%;'><div class='slide' style='width:100%;'><font color='#0000AA' style='font-style:italic;text-align:left;display:inline-block;'>Option #d:<input type='text' name='choice4' value='' onblur='javascript:displayresponsekeycontrols();' class='form-control input-ty-tiny' style='display:inline-block;'></font></div></span><br />"
        if challenge_dict['options'].__len__() > 4 and challenge_dict['options'][4]:
            challenge_dict['answeringoptions'] += "<span class='slide-container' style='width:100%%;'><div class='slide' style='width:100%%;'><font color='#0000AA' style='font-style:italic;text-align:left;display:inline-block;'>Option #e: <input type='text' name='choice5' value='%s' onblur='javascript:displayresponsekeycontrols();' class='form-control input-ty-tiny' style='display:inline-block;'></font></div></span><br />"%(challenge_dict['options'][4])
        else:
            challenge_dict['answeringoptions'] += "<span class='slide-container' style='width:100%;'><div class='slide' style='width:100%;'><font color='#0000AA' style='font-style:italic;text-align:left;display:inline-block;'>Option #e: <input type='text' name='choice5' value='' onblur='javascript:displayresponsekeycontrols();' class='form-control input-ty-tiny' style='display:inline-block;'></font></div></span><br />"
        if challenge_dict['options'].__len__() > 5 and challenge_dict['options'][5]:
            challenge_dict['answeringoptions'] += "<span class='slide-container' style='width:100%%;'><div class='slide' style='width:100%%;'><font color='#0000AA' style='font-style:italic;text-align:left;display:inline-block;'>Option #f:<input type='text' name='choice6' value='%s' onblur='javascript:displayresponsekeycontrols();' class='form-control input-ty-tiny' style='display:inline-block;'></font></div></span><br />"%(challenge_dict['options'][5])
        else:
            challenge_dict['answeringoptions'] += "<span class='slide-container' style='width:100%;'><div class='slide' style='width:100%;'><font color='#0000AA' style='font-style:italic;text-align:left;display:inline-block;'>Option #f:<input type='text' name='choice6' value='' onblur='javascript:displayresponsekeycontrols();' class='form-control input-ty-tiny' style='display:inline-block;'></font></div></span><br />"
        if challenge_dict['options'].__len__() > 6 and challenge_dict['options'][6]:
            challenge_dict['answeringoptions'] += "<span class='slide-container' style='width:100%%;'><div class='slide' style='width:100%%;'><font color='#0000AA' style='font-style:italic;text-align:left;display:inline-block;'>Option #g:<input type='text' name='choice7' value='%s' onblur='javascript:displayresponsekeycontrols();' class='form-control input-ty-tiny' style='display:inline-block;'></font></div></span><br />"%(challenge_dict['options'][6])
        else:
            challenge_dict['answeringoptions'] += "<span class='slide-container' style='width:100%;'><div class='slide' style='width:100%;'><font color='#0000AA' style='font-style:italic;text-align:left;display:inline-block;'>Option #g: <input type='text' name='choice7' value='' onblur='javascript:displayresponsekeycontrols();' class='form-control input-ty-tiny' style='display:inline-block;'></font></div></span><br />"
        if challenge_dict['options'].__len__() > 7 and challenge_dict['options'][7]:
            challenge_dict['answeringoptions'] += "<span class='slide-container' style='width:100%%;'><div class='slide' style='width:100%%;'><font color='#0000AA' style='font-style:italic;text-align:left;display:inline-block;'>Option #h:<input type='text' name='choice8' value='%s' onblur='javascript:displayresponsekeycontrols();' class='form-control input-ty-tiny' style='display:inline-block;'></font></div></span></br>"%(challenge_dict['options'][7])
        else:
            challenge_dict['answeringoptions'] += "<span class='slide-container' style='width:100%;'><div class='slide' style='width:100%;'><font color='#0000AA' style='font-style:italic;text-align:left;display:inline-block;'>Option #h:<input type='text' name='choice8' value='' onblur='javascript:displayresponsekeycontrols();' class='form-control input-ty-tiny' style='display:inline-block;'></font></div></span><br />"
        if challenge_dict['oneormore']:
