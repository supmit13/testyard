...
def editchallenge(request):
    ...
    if challenge_dict['testtype'] == 'COMP':
        challengetypeslist += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-weight:bold;justify:left;'>Select Challenge Type</font></div><div class='float-right' style='width:50%;'><select name='challengetype' onchange='javascript:displayoptions();'>"
        for ttcode in mysettings.TEST_TYPES.keys():
            ttcodeval = ttcode.replace(" ", "__")
        ...
        if challengeobj.challengetype == 'SUBJ':
            challengetypeslist += "<span class='slide-container'><div class='slide' id='ansopts'><font color='#0000AA' style='font-weight:bold;justify:left;'>Max Answer Length (characters, leave empty for no limit)</font></div><div class='float-right' style='width:50%;color:#0000AA;'><input type='text' name='maxsizewords' value='%s' size='6' maxlength='6'> </div></span>"%(challenge_dict['maxsizeallowable'].__str__())
        elif challengeobj.challengetype == 'CODN' or challengeobj.challengetype == 'ALGO':
            challengetypeslist += "<span class='slide-container'><div class='slide' id='ansopts'><font color='#0000AA' style='font-weight:bold;justify:left;'>Max Answer Length (lines, leave empty for no limit)</font></div><div class='float-right' style='width:50%;color:#0000AA;'> <input type='text' name='maxsizelines' value='%s' size='6' maxlength='6'> </div></span>"%(challenge_dict['maxsizeallowable'].__str__())
        else:
            pass
    ...
    if challengeobj.challengetype == 'MULT':
        ...
        if challenge_dict['oneormore']:
            challenge_dict['answeringoptions'] += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-weight:bold;justify:left;'>Can there be more than one correct option:&nbsp;</font></div><div class='float-right' style='width:50%;color:#0000AA;'><input type='radio' name='oneormore' value='yes' checked=true onchange='javascript:displayresponsekeycontrols();'><font color='#0000AA' size=-1>Yes</font>&nbsp;&nbsp;&nbsp;&nbsp;<input type='radio' name='oneormore' value='no' onchange='javascript:displayresponsekeycontrols();'><font color='#0000AA' size=-1>No</font></div></span><br />"
        else:
        ...
        if challenge_dict['options'].__len__() > 0 and challenge_dict['options'][0]:
            challenge_dict['answeringoptions'] += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;justify:left;'>Option #a:</font></div> <div class='float-right' style='width:50%%;color:#0000AA;'><input type='text' name='choice1' value='%s' onblur='javascript:displayresponsekeycontrols();'></div></span><br />"%(challenge_dict['options'][0])
        else:
            challenge_dict['answeringoptions'] += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;justify:left;'>Option #a:</font></div> <div class='float-right' style='width:50%;color:#0000AA;'><input type='text' name='choice1' value='' onblur='javascript:displayresponsekeycontrols();'></div></span><br />"
        if challenge_dict['options'].__len__() > 1 and challenge_dict['options'][1]:
            challenge_dict['answeringoptions'] += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;justify:left;'>Option #b:</font></div> <div class='float-right' style='width:50%%;color:#0000AA;'><input type='text' name='choice2' value='%s' onblur='javascript:displayresponsekeycontrols();'></div></span><br />"%(challenge_dict['options'][1])
        else:
            challenge_dict['answeringoptions'] += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;justify:left;'>Option #b:</font></div> <div class='float-right' style='width:50%;color:#0000AA;'> <input type='text' name='choice2' value='' onblur='javascript:displayresponsekeycontrols();'></div></span><br />"
        if challenge_dict['options'].__len__() > 2 and challenge_dict['options'][2]:
            challenge_dict['answeringoptions'] += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;justify:left;'>Option #c:</font></div> <div class='float-right' style='width:50%%;color:#0000AA;'><input type='text' name='choice3' value='%s' onblur='javascript:displayresponsekeycontrols();'></div></span><br />"%(challenge_dict['options'][2])
        else:
            challenge_dict['answeringoptions'] += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;justify:left;'>Option #c:</font></div> <div class='float-right' style='width:50%;color:#0000AA;'> <input type='text' name='choice3' value='' onblur='javascript:displayresponsekeycontrols();'></div></span><br />"
        if challenge_dict['options'].__len__() > 3 and challenge_dict['options'][3]:
            challenge_dict['answeringoptions'] += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;justify:left;'>Option #d:</font></div> <div class='float-right' style='width:50%%;color:#0000AA;'><input type='text' name='choice4' value='%s' onblur='javascript:displayresponsekeycontrols();'></div></span><br />"%(challenge_dict['options'][3])
        else:
            challenge_dict['answeringoptions'] += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;justify:left;'>Option #d:</font></div> <div class='float-right' style='width:50%;color:#0000AA;'> <input type='text' name='choice4' value='' onblur='javascript:displayresponsekeycontrols();'></div></span><br />"
        if challenge_dict['options'].__len__() > 4 and challenge_dict['options'][4]:
            challenge_dict['answeringoptions'] += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;justify:left;'>Option #e:</font></div> <div class='float-right' style='width:50%%;color:#0000AA;'> <input type='text' name='choice5' value='%s' onblur='javascript:displayresponsekeycontrols();'></div></span><br />"%(challenge_dict['options'][4])
        else:
            challenge_dict['answeringoptions'] += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;justify:left;'>Option #e:</font></div> <div class='float-right' style='width:50%;color:#0000AA;'> <input type='text' name='choice5' value='' onblur='javascript:displayresponsekeycontrols();'></div></span><br />"
        if challenge_dict['options'].__len__() > 5 and challenge_dict['options'][5]:
            challenge_dict['answeringoptions'] += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;justify:left;'>Option #f:</font></div> <div class='float-right' style='width:50%%;color:#0000AA;'><input type='text' name='choice6' value='%s' onblur='javascript:displayresponsekeycontrols();'></div></span><br />"%(challenge_dict['options'][5])
        else:
            challenge_dict['answeringoptions'] += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;justify:left;'>Option #f:</font></div> <div class='float-right' style='width:50%;color:#0000AA;'> <input type='text' name='choice6' value='' onblur='javascript:displayresponsekeycontrols();'></div></span><br />"
        if challenge_dict['options'].__len__() > 6 and challenge_dict['options'][6]:
            challenge_dict['answeringoptions'] += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;justify:left;'>Option #g:</font></div> <div class='float-right' style='width:50%%;color:#0000AA;'> <input type='text' name='choice7' value='%s' onblur='javascript:displayresponsekeycontrols();'></div></span><br />"%(challenge_dict['options'][6])
        else:
            challenge_dict['answeringoptions'] += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;justify:left;'>Option #g:</font></div> <div class='float-right' style='width:50%;color:#0000AA;'> <input type='text' name='choice7' value='' onblur='javascript:displayresponsekeycontrols();'></div></span><br />"
        if challenge_dict['options'].__len__() > 7 and challenge_dict['options'][7]:
            challenge_dict['answeringoptions'] += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;justify:left;'>Option #h:</font></div> <div class='float-right' style='width:50%%;color:#0000AA;'><input type='text' name='choice8' value='%s' onblur='javascript:displayresponsekeycontrols();'></div></span></br>"%(challenge_dict['options'][7])
        else:
            challenge_dict['answeringoptions'] += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;justify:left;'>Option #h:</font></div> <div class='float-right' style='width:50%;color:#0000AA;'><input type='text' name='choice8' value='' onblur='javascript:displayresponsekeycontrols();'></div></span><br />"
        if challenge_dict['oneormore']:
            for option in challenge_dict['options']:
                if option  in challenge_dict['responsekey']:
                    challenge_dict['responsekeyscontrolslist'] += "<span class='slide-container' style='width:100%;'><div class='slide' style='width:100%;'><font color='#0000AA' style='font-style:italic;justify:left;'><input type='checkbox' name='responsekey[]' value='" + option  + "' checked>" + option + "</font></div></span><br>"
                else:
                    challenge_dict['responsekeyscontrolslist'] += "<span class='slide-container' style='width:100%;'><div class='slide' style='width:100%;'><font color='#0000AA' style='font-style:italic;justify:left;'><input type='checkbox' name='responsekey[]' value='" + option + "'>" + option + "</font></div></span><br>"
        else: # Only one option is correct
            for option in challenge_dict['options']:
                if option  in challenge_dict['responsekey']:
                    challenge_dict['responsekeyscontrolslist'] += "<span class='slide-container' style='width:100%;'><div class='slide' style='width:100%;'><font color='#0000AA' style='font-style:italic;justify:left;'><input type='radio' name='responsekey' value='" + option  + "' checked=true>" + option + "</font></div></span><br>"
                else:
                    challenge_dict['responsekeyscontrolslist'] += "<span class='slide-container' style='width:100%;'><div class='slide' style='width:100%;'><font color='#0000AA' style='font-style:italic;justify:left;'><input type='radio' name='responsekey' value='" + option + "'>" + option + "</font></div></span><br>"
    elif challengeobj.challengetype == 'FILB':
         challenge_dict['responsekeyscontrolslist'] += "<span class='slide-container'><div class='slide'><font color='#0000AA' style='font-style:italic;justify:left;'>Enter the correct response<font size='-2'><a href='#' onmouseover='javascript:showwhyresponsekey(this);'>[why should I do this?]</a></font>:</font></div> <div class='float-right' style='width:50%%;color:#0000AA;'><input type='text' name='responsekey' value='%s' size='10' maxlength='250'></div></span><br>"%(challenge_dict['responsekey'][0])
